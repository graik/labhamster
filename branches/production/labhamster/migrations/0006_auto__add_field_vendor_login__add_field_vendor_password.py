...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vendor.login'
        db.add_column('labhamster_vendor', 'login', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Vendor.password'
        db.add_column('labhamster_vendor', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vendor.login'
        db.delete_column('labhamster_vendor', 'login')

        # Deleting field 'Vendor.password'
        db.delete_column('labhamster_vendor', 'password')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 15, 4, 25, 863205)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 15, 4, 25, 863151)'}),
        ...
        'labhamster.order': {
            'Meta': {'ordering': "('date_created', 'id')", 'object_name': 'Order'},
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'unit_size': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        'labhamster.vendor': {
