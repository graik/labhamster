...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('labhamster_item', 'id')


        # Changing field 'Item.name'
        db.alter_column('labhamster_item', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, primary_key=True))

        # Changing field 'Item.shelflife'
        db.alter_column('labhamster_item', 'shelflife', self.gf('labhamster.customfields.datafields.DayModelField')(null=True))
    def backwards(self, orm):
        # Adding field 'Item.id'
        db.add_column('labhamster_item', 'id',
        ...
        # Changing field 'Item.shelflife'
        db.alter_column('labhamster_item', 'shelflife', self.gf('django.db.models.fields.IntegerField')(null=True))
    models = {
        'auth.group': {
