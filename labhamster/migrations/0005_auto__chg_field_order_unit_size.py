...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.unit_size'
        db.alter_column('labhamster_order', 'unit_size', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Order.unit_size'
        db.alter_column('labhamster_order', 'unit_size', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 17, 13, 27, 963428)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 17, 13, 27, 963376)'}),
